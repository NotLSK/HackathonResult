...
export class CustomMessageModule extends Module {
  constructor(type, text) {
    ...
    this.messages = [
        ...
        "— Почему JavaScript-программист не может найти жену?<br>— Потому что он вечно ищет this, а оно всегда не там, где он ожидает!",
        "— Почему новички путают == и ===?<br>— Потому что один знак '=' — это присвоение, два — 'ну ладно, сравни', а три — 'СЕРЬЁЗНО, СРАВНИ ТОЧНО!'",
        "— Что говорит JavaScript-программист, когда у него всё работает с первого раза?<br>— Что-то тут не так…",
        "— Почему null и undefined не дружат?<br>— Потому что null — это сознательное 'ничего', а undefined — это 'я даже не знаю, что это'.",
